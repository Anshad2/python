...
# q2 print all directors name
# for movie_name in movies:
#     print(movie_name.get("director"))

# q3 print all year
# for movie_name in movies:
    # print(movie_name.get("year"))


# q4 print title start with A
# starts_A_with=[movie_name.get("title")for movie_name in movies if movie_name.get("title").startswith("A")]
# print(starts_A_with)

# q5 max run time
# max_run_time=max(movies,key=lambda m:int(m.get("runtime")))
# print(max_run_time.get("title"))

# q6 min run time
# min_run_time=min(movies,key=lambda m:int(m.get("runtime")))
# print(min_run_time.get("title"))

# q7 geners more than 2
# genres_more_2=[movie_name.get("title")for movie_name in movies if len(movie_name.get("genres"))>2]
# print(genres_more_2)

# q8 print movies after 2000
# movie_after_2000=[movie_name.get("title")for movie_name in movies if movie_name.get("year")>"2000"]
# print(movie_after_2000)

# # q8 number of movie in each year
# movies_count={}
# for movie_name in movies:
#   movie_year=movie_name.get("year")
#   if movie_year in movies_count:
#       movies_count[movie_year]+=1
#   else:
#    movies_count[movie_year]=1
# print(movies_count)
# value_key=[(v,k)for k,v in movies_count.items()]#here value and key reversed
# print(max(value_key))
...
# q9 drama and biography movies
# for movie_name in movies:
#   if "Drama" and "Biography" in movie_name.get("genres"):
#    print(movie_name.get("title"))

# q10 run time more than 100
# run_time=[movie_name.get("title")for movie_name in movies if movie_name.get("runtime")>"100"]
# print(run_time)


# q11 movie in 2010
# movie_in_2010=[movie_name.get("title")for movie_name in movies if movie_name.get("year")=="2010"]
# print(movie_in_2010)


# # q12 id based moviename
# filim_id=int(input("enter film id"))
# for movie_name in movies:
#     if filim_id==movie_name.get("id"):
#         print(movie_name.get("title"))


# q13 most genre count
genres_count={}
for m in movies:
    genres=m.get("genres")
    for g in genres:
        if g in genres_count:
            ...
            genres_count[g]=1
g_c=[(v,k) for k,v in genres_count.items()]
print(max(g_c))
...
for movie_name in movies:
    movie_year=movie_name.get("year")
    if movie_year in year_count:
        year_count[movie_year]+=1
    else:
        year_count[movie_year]=1
print(year_count)
y_c=[(v,k)for k,v in year_count.items()]
print(y_c)
print(max(y_c))
